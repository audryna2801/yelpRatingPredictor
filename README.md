...
We optimized our model using the standard training-testing split 80-20 as well as a 5-95 split. Our best combination (ngram, num_stop_words, alpha) was: (2, 0, 0.0001) for the first split and (xxx) for the second. The resulting combination was mostly similar, except for the alpha parameter. This indicates that our optimizing function is more or less robust. 
